...
{
    [DbContext(typeof(SpiderAppDbContext))]
    partial class SpiderAppDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Danny.SpiderApp.THZ.Thz_DetailInfo", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<Guid>("ListInfoId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("Mosaic")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ListInfoId")
                        .IsUnique();

                    b.ToTable("Thz_DetailInfo", (string)null);
                });

            modelBuilder.Entity("Danny.SpiderApp.THZ.Thz_ListInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Thz_ListInfo", (string)null);
                });

            modelBuilder.Entity("Danny.SpiderApp.THZ.Thz_Website", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Thz_Website", (string)null);
                });
            ...
            modelBuilder.Entity("Danny.SpiderApp.THZ.Thz_DetailInfo", b =>
                {
                    b.HasOne("Danny.SpiderApp.THZ.Thz_ListInfo", "ListInfo")
                        .WithOne("DetailInfo")
                        .HasForeignKey("Danny.SpiderApp.THZ.Thz_DetailInfo", "ListInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ListInfo");
                });
